...
logo= f'''
 $ $${GREEN}     __   ____  _  _________ 
$ $${GREEN}    / /  / __ \/ |/ / __/ _ \
$ $${GREEN}   / /__/ /_/ /    / _// , _/
$ $${GREEN}  /____/\____/_/|_/___/_/|_| 
...
def qsbuy():
	try:
		...
		try:
			...
			os.system("clear");print(logo)
			print(50*"-")
			print(f"${GREEN}   [+]Key : {bumper}{s}")
			print(50*"-")
			input("[+]${CYAN} Contact admin for key approval ")
...
class crack_main():
	...
	def cracknum(self,id):
		global methods
		os.system('clear');print(logo);xchker()
		print('${GREEN} For Example :\033[0m 92310,92342,92300,92301 ...')
		kode = input('${GREEN}   [+]Choose Code : \033[0m')
		print('${GREEN}For Example :\033[0m 2000,4000,6000 ...')
		limit = int(input('${GREEN} IDs Limit : \033[0m'))
		for nmbr in range(limit):
...
def new_file(cookies,access_token):
	...
	for xd in range(fl):
		...
		try:
			...
			print(' No internet connection ....')
	print('\n ${GREEN} Example: 100087,100088 etc\033[0;97m')
	try:
...
def sep():
	...
	file_name = input('${GREEN} [+]lnput file path : ')
	print(f'{rg} Save As Example /sdcard/newfile.txt{s}')
	new_save = input('\n ${RED}[+] Save new file as : ')
	y = 0
...
def sep():
	...
	try:
		...
		limit = 1
	print(f'${GREEN} File Path Example /sdcard/xxx.txt{s}')
	file_name = input('[+] Input file path : ')
	print(f'[+] Save As Example /sdcard/newfile.txt')
	new_save = input('${GREEN} Save new file as : ')
	y = 0
